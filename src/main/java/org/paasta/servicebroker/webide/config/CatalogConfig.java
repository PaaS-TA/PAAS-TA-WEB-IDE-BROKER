...
public class CatalogConfig {
    ...
    public Catalog catalog(){
       ...
       return new Catalog(Arrays.asList(
               new ServiceDefinition(
                       ...
                       SERVICEDEFINITION_BINDABLE,
                       SERVICEDEFINITION_PLANUPDATABLE,
                       Arrays.asList(
    ...
    private Map<String, Object> getServiceDefinitionMetadata() {
        ...
        sdMetadata.put("displayName", "Web Ide Service");
        sdMetadata.put("imageUrl", "");
        sdMetadata.put("longDescription", "Paas-TA Web ide");
        sdMetadata.put("providerDisplayName", "PaaS-TA WEB-IDE");
    ...
    private List<String> getBullets(String planType) {
        if (planType.equals("A")) {
            return Arrays.asList("WEB-IDE shared build server use", "WEB-IDE build service using a shared server");
        }
        else if (planType.equals("B")) {
            return Arrays.asList("WEB-IDE dedicated build server use", "WEB-IDE build service using a dedicated server");
        }
        return Arrays.asList("WEB-IDE shared build server use", "WEB-IDE build service using a shared server");
    }
}
